...
async def summary_endpoint(
    ...
    return get_summary(db, current_user_id, start_date, end_date)
...
async def spending_by_category_endpoint(
    ...
    return get_spending_by_category(db, current_user_id, start_date, end_date)
...
async def monthly_trend_endpoint(
    ...
    return get_monthly_trend(db, current_user_id, months)
...
async def income_vs_expense_endpoint(
    ...
    return get_income_vs_expense(db, current_user_id, start_date, end_date)
